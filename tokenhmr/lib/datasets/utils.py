...
def get_example(img_path, center_x: float, center_y: float,
                ...
                dataset: str = None, return_newbox: bool = False,) -> Tuple:
    """
    ...
    if isinstance(img_path, str):
        ...
        if dataset is not None and 'closeup' in dataset:
    ...
    if not return_trans:
        ...
        if return_newbox:
            return img_patch, keypoints_2d, keypoints_3d, smpl_params, has_smpl_params, img_size, center_x, center_y, patch_width, patch_height, trans
