...
class TokenHMRDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if self.train_dataset == None:
            ...
            self.mocap_dataset = MoCapDataset(dataset_file=os.path.join(self.cfg.DATASETS.DATASET_DIR, self.dataset_cfg[self.cfg.DATASETS.MOCAP]['DATASET_FILE'])) 
    ...
    def train_dataloader(self) -> Dict:
        ...
        """
        if self.cfg.GENERAL.NUM_WORKERS>0:
